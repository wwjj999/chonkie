"""TokenProcessor class for handling tokenization operations using various backends."""
...
class TokenProcessor:
    ...
    def __init__(
        ...
        tokenizer_or_token_counter: Union[
            str, Callable, "tiktoken.Encoding", "Tokenizer"
        ],
    ) -> None:
    ...
    def _get_tokenizer_backend(self) -> str:
        ...
        # If the tokenizer is a transformers.AutoTokenizer object, then the backend is "transformers"
            ...
            raise ValueError(
                "OOOOOOPS! We don't support this tokenizer backend yet! 🦛😅"
            )
