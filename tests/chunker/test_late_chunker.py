...
def test_late_chunker_initialization(embedding_model: SentenceTransformerEmbeddings) -> None:
...
def test_late_chunker_invalid_mode(embedding_model: SentenceTransformerEmbeddings) -> None:
    """Test that the LateChunker raises error for invalid mode."""
    with pytest.raises(ValueError):
        LateChunker(embedding_model=embedding_model, mode="invalid")


def test_late_chunker_sentence_mode(embedding_model: SentenceTransformerEmbeddings, sample_text: str) -> None:
...
def test_late_chunker_token_mode(embedding_model: SentenceTransformerEmbeddings, sample_text: str) -> None:
...
def test_late_chunker_empty_text(embedding_model: SentenceTransformerEmbeddings) -> None:
...
def test_late_chunker_single_sentence(embedding_model: SentenceTransformerEmbeddings) -> None:
...
def test_late_chunker_sentence_boundaries(embedding_model: SentenceTransformerEmbeddings) -> None:
...
def test_late_chunker_embedding_dimensions(embedding_model: SentenceTransformerEmbeddings, sample_text: str) -> None:
